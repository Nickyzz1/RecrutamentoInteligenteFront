        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-col flex-grow bg-[#F9FAFB]">
                ...
                <div className="flex flex-col items-center w-full">
                    <div className="flex flex-col bg-white border-[1px] border-gray-200 p-3 gap-7 max-w-[1000px] w-5/6 rounded-2xl">
                        <p className="text-2xl font-bold">{vacancy ? vacancy.title : ""}</p>

                        <div className="flex flex-col gap-2">
                            <p className="text-[#909192]">Preencha seu currículo para se candidatar a esta vaga</p>
                            <div className="flex items-center hover:bg-gray-200 justify-between bg-[#F6F6F6] border-[1px] border-gray-200 p-4 px-6 gap-4 rounded-2xl flex-row">
                                <p className="font-semibold">Prencher currículo</p>
                                <IconButton onClick={() => r.push(ROUTES.resume)}><NavigateNextIcon/></IconButton>
                            </div>
                        </div>
                        ...
                        {/* <Button onClick={send} sx={{backgroundColor: '#036d3c'}} text-white p-2 flex justify-center items-center rounded-xl">Candidatar-se</Button> */}
                        <Button onClick={send} sx={{backgroundColor: '#036d3c', color: "#FAFFFDFF"}}>Candidatar-se</Button>
