...
export default function Home() {
  return (
    <>
      <HeaderNotLogged/>
      <div className="flex flex-col w-screen bg-[#F9FAFB] md:p-10 p-5">
          ...
          <div className="flex flex-col items-center w-full gap-2">
            ...
            <div className="flex items-center justify-center w-full">
              <h2 className="text-sm w-1/2 self-center text-center text-gray-500">Explore novas vagas disponíveis e dê o próximo passo na sua carreira profissional</h2>
            </div>
          </div>
